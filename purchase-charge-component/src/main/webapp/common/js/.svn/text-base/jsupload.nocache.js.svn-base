function jsupload() {
	var bb = '', $ = ' top: -1000px;', yb = '" for "gwt:onLoadErrorFn"', wb = '" for "gwt:onPropertyErrorFn"', hb = '");', zb = '#', $b = '.cache.js', Bb = '/', Hb = '//', Ub = '3D6E9AE8026DE31E4EA102148C041EE5', Zb = ':', Vb = ':1', Wb = ':2', Xb = ':3', Yb = ':4', qb = '::', kc = ':moduleBase', ab = '<!doctype html>', cb = '<html><head><\/head><body><\/body><\/html>', tb = '=', Ab = '?', vb = 'Bad handler "', _ = 'CSS1Compat', fb = 'Chrome', eb = 'DOMContentLoaded', V = 'DUMMY', ec = 'GWTCStandard.css', jc = 'Ignoring non-whitelisted Dev Mode URL: ', ic = '__gwtDevModeHook:jsupload', Gb = 'base', Eb = 'baseUrl', Q = 'begin', W = 'body', P = 'bootstrap', Db = 'clear.cache.gif', sb = 'content', fc = 'end', gb = 'eval("', hc = 'file:', Pb = 'gecko', Qb = 'gecko1_8', R = 'gwt.codesvr.jsupload=', S = 'gwt.codesvr=', xb = 'gwt:onLoadErrorFn', ub = 'gwt:onPropertyErrorFn', rb = 'gwt:property', mb = 'head', cc = 'href', gc = 'http:', Mb = 'ie10', Ob = 'ie8', Nb = 'ie9', X = 'iframe', Cb = 'img', jb = 'javascript', Y = 'javascript:""', T = 'jsupload', Tb = 'jsupload.devmode.js', Fb = 'jsupload.nocache.js', pb = 'jsupload::', _b = 'link', dc = 'loadExternalRefs', nb = 'meta', lb = 'moduleRequested', kb = 'moduleStartup', Lb = 'msie', ob = 'name', Z = 'position:absolute; width:0; height:0; border:none; left: -1000px;', ac = 'rel', Kb = 'safari', ib = 'script', Sb = 'selectingPermutation', U = 'startup', bc = 'stylesheet', db = 'undefined', Rb = 'unknown', Ib = 'user.agent', Jb = 'webkit';
	var o = window;
	var p = document;
	r(P, Q);
	function q() {
	...
	jsupload.__sendStats = r;
	jsupload.__moduleName = T;
	jsupload.__errFn = null;
	jsupload.__moduleBase = V;
	jsupload.__softPermutationId = 0;
	jsupload.__computePropValue = null;
	jsupload.__getPropMap = null;
	jsupload.__gwtInstallCode = function() {
	};
	jsupload.__gwtStartLoadingFragment = function() {
		return null
	};
	var s = function() {
		return false
	...
	function C(k) {
		...
		function m(c) {
			...
			if (navigator.userAgent.indexOf(fb) > -1 && window.JSON) {
				...
				for ( var i = 0; i < c.length; i++) {
					...
					h.appendChild(f
							.createTextNode(j.substring(1, j.length - 1)))
				}
		...
		jsupload.onScriptDownloaded = function(a) {
			l(function() {
				m(a)
			})
		};
	...
	jsupload.__startLoadingFragment = function(a) {
		return G(a)
	};
	jsupload.__installRunAsyncCode = function(a) {
		var b = A();
	...
	function D() {
		...
		for ( var g = 0, h = f.length; g < h; ++g) {
			var i = f[g], j = i.getAttribute(ob), k;
			if (j) {
				j = j.replace(pb, bb);
				if (j.indexOf(qb) >= 0) {
					continue
	...
	function F() {
		...
		function j() {
			var a = p.location;
			return a.href == a.protocol + Hb + a.host + a.pathname + a.search
					+ a.hash
		}
		var k = g();
		if (k == bb) {
	...
	function G(a) {
		...
		return jsupload.__moduleBase + a
	}
	function H() {
		var f = [];
		var g;
		...
		jsupload.__getPropMap = function() {
			var a = {};
			for ( var b in i) {
		...
		jsupload.__computePropValue = k;
		o.__gwt_activeModules[T].bindings = jsupload.__getPropMap;
		r(P, Sb);
		if (q()) {
			return G(Tb)
		}
		...
		jsupload.__softPermutationId = g;
		return G(l + $b)
	}
	function I() {
	...
	D();
	jsupload.__moduleBase = F();
	u[T].moduleBase = jsupload.__moduleBase;
	var J = H();
	if (o) {
