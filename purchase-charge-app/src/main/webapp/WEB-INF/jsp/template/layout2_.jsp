...
<div id="content">
    ...
    <div class="easyui-layout" data-options=""
		...
		<div data-options="region:'west',title:'',border:false,split:true" style="width:300px; padding-left:7px">
			<jsp:include page="addWidgets2_.jsp?region=left" />
		</div>
		<div data-options="region:'center',border:false" style="">
			<jsp:include page="addWidgets2_.jsp?region=right" />
		</div>
	</div> 
