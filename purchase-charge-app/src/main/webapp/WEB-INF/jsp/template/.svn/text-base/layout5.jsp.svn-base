<%--
 ...
 This template has two columns 'left' and 'right, that are each half the page
 wide. Below them is a single column called 'bottom' that spans the entire page.
--%>
...
<div id="content">
    ...
    <jsp:include page="addWidgets.jsp?region=bottom&div=bottom" />
